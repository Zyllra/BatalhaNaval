...
int main() {
    ...
    printf("\n==== INSTRUCOES ===="
           "\npra jogar, primeiro escolha a linha, dps aperta enter"
           "\ndepois escolhe a coluna e aperta enter dnv"
           "\n\nSIMBOLOS:"
           "\n~ = local nao foi acertado"
           "\n* = vc atirou mas n acertou nada"
           "\nX = acertou um navio\n\n");
    ...
    printf("\n\n\nJogo terminado! Vc acertou os 3 navios em %d tentativas\n", tentativas);
    mostraTabuleiro(tabuleiro);
}
